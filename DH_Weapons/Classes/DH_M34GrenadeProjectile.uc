...
class DH_M34GrenadeProjectile extends DHCannonShellHEAT;
// Code copied from RPG-43 grenade in order to have the impact fuse
// Not an anti-tank grenade, so penetration values are small
